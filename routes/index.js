...
router.get(
  ...
  passport.authenticate("google", {
    successRedirect: "/locations", // where do you want the client to go after you login
    failureRedirect: "/locations", // where do you want the client to go if login fails
  })
);
